...
// use ms for miliionseconds; s for seconds
using namespace std::chrono_literals;
using std::chrono::milliseconds;
// Truyền đối số đầu tiên với callback
using std::placeholders::_1;
// bool for multi-threaded
...
public:
    ...
    BT::NodeStatus tick() override
    {
        ...
        // 200 readings, from 0->2pi, right to left
        float min = 10;
        float current;
        for (int i = 0; i < 200; i++)
        {
...
public:
    ...
    NodeStatus tick() override
    {
        ...
        return position_x > 2.0 || position_y > 2.0 ? NodeStatus::SUCCESS
                                                    : NodeStatus::FAILURE;
    }
    static PortsList providedPorts()
    {
...
/*------------------------------ROTATING ROBOT---------------*/
  ...
  <root >
      <BehaviorTree>
      <Sequence>
        <SetBlackboard   output_key="Interface" value="300" />
